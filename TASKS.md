...
кнопки Старт/Стоп (Старт заблокирован если не выполнены предусловия); прогресс + хвост лога;
список найденных рабочих стратегий (накопительно).
**Критерий приёмки:** запуск/остановка из UI; виден прогресс и найденные рабочие стратегии.

### T24 · Применить найденную стратегию · M · todo
Кнопка «применить» у рабочей стратегии → запись в zapret.sh + рестарт zapret (пересекается с T21).
**Критерий приёмки:** выбранная стратегия применяется, smoke PASS.
