...
Применение — рестарт zapret. Осторожно: стратегии калиброваны (см. STRATEGIES.md).
**Критерий приёмки:** просмотр текущих стратегий и доменов zapret; правка применяется и не ломает zapret (smoke PASS).
